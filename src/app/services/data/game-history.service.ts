...
import { IGameHistory } from 'src/app/interfaces/game-history';
...
export class GameHistoryService {
  ...
  apiGetReceivedPrizes(msisdn: any) {
    ...
    return this.http.post<IResponsePage<IReceivedPrize>>(
      'game-history/received-prize',
      this.request
    );
  }
  ...
  apiPlayGame(data: any) {
    return this.http.post<IGameHistory>('game-history/play', data);
  }
}
